...
/* One metro station's rider pool (InitMetroPeople 1220:0d88): 240 person
 * records of type 0x21. Each idle rider rolls rand%36==0 per 16-ft sim
 * visit inside the 10AM-5PM window (1220:51dc, injection 50e2) — no
 * batches, no train gating. Expected ~218 single visits/day, 280-460
 * with same-day re-entry (metro-pacing referee 2026-08-03). */
#define METRO_VISITOR_POOL 240
